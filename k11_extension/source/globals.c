...
bool (*KSynchronizationObject__RegisterSyncWithThread)(KSynchronizationObject *this, KThread* thread);
bool (*KSynchronizationObject__UnRegisterSyncWithThread)(KSynchronizationObject *this, KThread* thread);
